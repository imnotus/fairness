...
void PA_NOMA_pr_dst(double lambda_IoT, double alpha, double noise, double L, int C, string s, double D) {
    ...
    if (D == 0) { //電力配分最適化
        if (L == 2) coef = {0, 0.4718};
        else if (L == 3) coef = {0, 0.3605, 0.5959};
        else if (L == 4) coef = {0, 0.3037, 0.4722, 0.6704};
        else if (L == 5) coef = {0, 0.267434, 0.4051755, 0.545601, 0.72};
        else if (L == 6) coef = {0, 0.2407, 0.3606, 0.4719, 0.5961, 0.7641};
        else if (L == 7) coef = {0, 0.2222, 0.32866, 0.424, 0.5236, 0.6371, 0.7972};
        else if (L == 8) coef = {0, 0.207, 0.304, 0.3891, 0.4731, 0.5631, 0.671, 0.8245};
        else if (L == 9) coef = {0, 0.1939, 0.2837, 0.3607, 0.4345, 0.5112, 0.596, 0.699, 0.8472};
        else if (L == 10) coef = {0, 0.18317, 0.26705, 0.3377, 0.4049, 0.4724, 0.5433, 0.624, 0.7233, 0.8679};
    } else {
        for (int i = 0; i < L; i++) {
